        ...
        return view('backend/edit', self::prepareConfig([
            ...
            'tabs' => [
                [
                    'title' => __('General'),
                    'fields' => [
                        ['label' => __('Name'), 'type' => 'text', 'id' => 'name', 'placeholder' => __('Name'), 'required' => true, 'value' => $product->name],
                        ['label' => __('Description'), 'type' => 'editor', 'id' => 'description', 'placeholder' => __('Description'), 'required' => false, 'value' => $product->description],
                        ['label' => __('Price (€)'), 'type' => 'number', 'id' => 'price', 'placeholder' => __('Price'), 'required' => false, 'value' => $product->price],
                        ['label' => __('Stock'), 'type' => 'number', 'id' => 'stock', 'placeholder' => __('Stock'), 'required' => true, 'value' => $product->stock],
                        ['label' => __('Hidden'), 'type' => 'checkbox', 'id' => 'hidden', 'required' => false, 'checked' => (bool)$product->hidden],
                        ['label' => __('Media'), 'type' => 'media', 'id' => 'media', 'placeholder' => __('Media'), 'required' => false, 'value' => (array)$product->media],
            ...
            'tabs' => [
                [
                    ...
                    'fields' => [
                        ...
                        ['label' => __('Description'), 'type' => 'editor', 'id' => 'description', 'placeholder' => __('Description'), 'required' => false],
                        ['label' => __('Price (€)'), 'type' => 'number', 'id' => 'price', 'placeholder' => __('Price'), 'required' => false],
                        ['label' => __('Stock'), 'type' => 'number', 'id' => 'stock', 'placeholder' => __('Stock'), 'required' => true],
